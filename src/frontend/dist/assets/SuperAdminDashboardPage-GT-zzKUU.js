import { r as reactExports, j as jsxRuntimeExports } from "./index-MRtoCDWo.js";
import { d as createLucideIcon, m as useHospitals, e as useGetAllTests, H as HealthcareBg, F as FlaskConical, b as FileText } from "./ProfileSetupModal-DsNpyszE.js";
import { P as PageHeroHeader } from "./PageHeroHeader-BkH3FlzT.js";
import { e as getDashboardMetrics } from "./backendService-CU726I6a.js";
import { c as formatCurrency } from "./formatters-DgcbtmQq.js";
import { L as LayoutDashboard, T as TrendingUp, b as TestTube } from "./StaffApp-BBfDbPBN.js";
import { I as IndianRupee } from "./indian-rupee-DL7QHU7h.js";
import { B as Building2 } from "./building-2-BkYRfHAR.js";
import { U as Users } from "./users-Cff8AFNo.js";
import { C as CircleAlert } from "./circle-alert-Cz9XJMQX.js";
import { M as Microscope } from "./microscope-BLVVr9Rg.js";
import { A as Activity } from "./activity-DGSf6yqs.js";
import { g as generateCategoricalChart, B as Bar, X as XAxis, Y as YAxis, f as formatAxisMap, R as ResponsiveContainer, L as LineChart, C as CartesianGrid, T as Tooltip, a as Line } from "./LineChart-DXvRtDWc.js";
import { C as ChevronLeft } from "./chevron-left-CgPlyvdh.js";
import { C as ChevronRight } from "./chevron-right-FQZiUxsm.js";
import { C as Clock } from "./clock-DTztC5to.js";
import { T as TriangleAlert } from "./triangle-alert-BDrNNKNj.js";
import "./plus-DWTJ3uqF.js";
import "./user-aOUTgKBy.js";
import "./package-DDxih6cy.js";
import "./map-pin-Bn9hERee.js";
import "./search-B517PK3W.js";
/**
...
function getUnsubmittedCount(_isDemoMode) {
  try {
...
function SuperAdminDashboardPage({
  ...
  const [backendMetrics, setBackendMetrics] = reactExports.useState(null);
  ...
  const metrics = reactExports.useMemo(() => {
    ...
    const activeHospitals = backendMetrics ? backendMetrics.activeHospitals : hospitals.filter((h) => h.isActive).length;
    return {
      revenueToday: (backendMetrics == null ? void 0 : backendMetrics.revenueToday) ?? 0,
      revenueMonth: 0,
      samplesToday: (backendMetrics == null ? void 0 : backendMetrics.samplesToday) ?? 0,
      activeHospitals,
      activePhlebotomists: 0,
      pendingReports: (backendMetrics == null ? void 0 : backendMetrics.pendingReports) ?? 0,
      collectionsToday: (backendMetrics == null ? void 0 : backendMetrics.collectionsToday) ?? 0,
      pendingPayments: 0,
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              ...
                              style: {
                                background: chartTab === "revenue" ? "linear-gradient(135deg, #2563EB, #1976D2)" : "transparent",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              ...
                              className: "px-3 py-1.5 rounded-lg text-xs font-semibold transition-all",
                              style: {
                                background: chartTab === "samples" ? "linear-gradient(135deg, #2563EB, #1976D2)" : "transparent",
