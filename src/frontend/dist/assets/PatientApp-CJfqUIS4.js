const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/PatientHomePage-B4xq8aHn.js","assets/index-C0bCdhlP.js","assets/index-cM6RQxPB.css","assets/ProfileSetupModal-Ol87SaTi.js","assets/MedicalCard-KqGMNovj.js","assets/activity-CsR0eSGm.js","assets/calendar-B6R9bgZJ.js","assets/arrow-right-QGXjiKcA.js","assets/BookTestPage-Dl7O-zFq.js","assets/button-BaiOHiN_.js","assets/index-BFphXJIQ.js","assets/input-BduaGY8N.js","assets/PageHeroHeader-I_60BDNi.js","assets/plus-CA7w3nlW.js","assets/search-C0qZf_Xt.js","assets/minus-DUnSLc8H.js","assets/SlotSelectionPage-DDfb-GD5.js","assets/index-CbijBIU0.js","assets/GradientButton-DWLm9W3Q.js","assets/clock-DFGjtTTs.js","assets/circle-check-DVmi2qZI.js","assets/MyBookingsPage-D7IyuNuW.js","assets/StatusBadge-Brk_mPfC.js","assets/MyHomeCollectionsPage-D-ycsrkQ.js","assets/map-pin-vFtSI1ge.js","assets/HomeCollectionPage-D9nDePKd.js","assets/navigation-B9arNG7K.js","assets/ReportsPage-DMCnbMI2.js","assets/eye-DPEniNPm.js","assets/download-CEGNtF7o.js","assets/MyVitalsPage-Cfwhg-xw.js","assets/heart-D4epg5vM.js","assets/ProfilePage-eH2kB6jA.js","assets/alert-dialog-Tc0VShUn.js","assets/badge-CAJt9IVp.js","assets/user-BRJpr7DQ.js","assets/building-2-BFl31qDW.js","assets/chevron-right-x83KUucZ.js","assets/log-out-CkAcAmEO.js","assets/MyHospitalSamplesPage-uruzT_bZ.js","assets/deliveryHelpers-Cl7zC1av.js","assets/truck-BbCNxJ1E.js","assets/microscope-DwsqtQxB.js","assets/package-BWiWTSJz.js","assets/chevron-up-IXKJTBFu.js"])))=>i.map(i=>d[i]);
import { a as useInternetIdentity, b as useQueryClient, j as jsxRuntimeExports, r as reactExports, L as LoadingScreen, E as ErrorBoundary, _ as __vitePreload } from "./index-C0bCdhlP.js";
import { G as GradientButton } from "./GradientButton-DWLm9W3Q.js";
import { H as HealthcareBg, F as FlaskConical, a as House, b as FileText, c as cn, u as useGetCallerUserProfile, P as ProfileSetupModal } from "./ProfileSetupModal-Ol87SaTi.js";
import { H as Heart } from "./heart-D4epg5vM.js";
import { A as Activity } from "./activity-CsR0eSGm.js";
...
const PatientHomePage = reactExports.lazy(() => __vitePreload(() => import("./PatientHomePage-B4xq8aHn.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7]) : void 0));
const BookTestPage = reactExports.lazy(() => __vitePreload(() => import("./BookTestPage-Dl7O-zFq.js"), true ? __vite__mapDeps([8,1,2,9,3,10,11,12,13,14,15,7]) : void 0));
const SlotSelectionPage = reactExports.lazy(
  () => __vitePreload(() => import("./SlotSelectionPage-DDfb-GD5.js"), true ? __vite__mapDeps([16,1,2,17,18,3,19,20]) : void 0)
);
const MyBookingsPage = reactExports.lazy(() => __vitePreload(() => import("./MyBookingsPage-D7IyuNuW.js"), true ? __vite__mapDeps([21,1,2,4,3,12,13,22,6,19]) : void 0));
const MyHomeCollectionsPage = reactExports.lazy(
  () => __vitePreload(() => import("./MyHomeCollectionsPage-D-ycsrkQ.js"), true ? __vite__mapDeps([23,1,2,4,3,22,24,19]) : void 0)
);
const HomeCollectionPage = reactExports.lazy(
  () => __vitePreload(() => import("./HomeCollectionPage-D9nDePKd.js"), true ? __vite__mapDeps([25,1,2,9,3,10,11,17,12,13,24,26,15,19,7]) : void 0)
);
const ReportsPage = reactExports.lazy(() => __vitePreload(() => import("./ReportsPage-DMCnbMI2.js"), true ? __vite__mapDeps([27,1,2,4,3,12,13,28,29]) : void 0));
const MyVitalsPage = reactExports.lazy(() => __vitePreload(() => import("./MyVitalsPage-Cfwhg-xw.js"), true ? __vite__mapDeps([30,1,2,4,3,5,31]) : void 0));
const ProfilePage = reactExports.lazy(() => __vitePreload(() => import("./ProfilePage-eH2kB6jA.js"), true ? __vite__mapDeps([32,1,2,33,3,9,10,34,11,17,35,36,37,38]) : void 0));
const PatientMyHospitalSamplesPage = reactExports.lazy(
  () => __vitePreload(() => import("./MyHospitalSamplesPage-uruzT_bZ.js"), true ? __vite__mapDeps([39,1,2,34,3,10,40,20,41,36,42,43,44]) : void 0)
);
const NAV_ITEMS = [
