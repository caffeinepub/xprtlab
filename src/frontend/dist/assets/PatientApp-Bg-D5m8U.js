const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/PatientHomePage-Ci6k_Bp6.js","assets/index-vGeq55gD.js","assets/index-D7Cc2zpq.css","assets/ProfileSetupModal-DOcw6VTl.js","assets/MedicalCard-CnWiIuj2.js","assets/activity-BR6O5kWC.js","assets/calendar-CTXRDAIx.js","assets/arrow-right-DzD435Y7.js","assets/BookTestPage-XiWn6DqC.js","assets/button-C2phJ2Qv.js","assets/index-xt4aa7P0.js","assets/input-C3KilcfH.js","assets/PageHeroHeader-Tq6-29Aa.js","assets/plus-Bi9c0P5D.js","assets/search-DEqUvxbm.js","assets/minus-DBEaALJ5.js","assets/SlotSelectionPage-BRtVE6uu.js","assets/index-Cr_KOa9D.js","assets/GradientButton-4fP7LxFy.js","assets/clock-D_f6oRgJ.js","assets/circle-check-UlLPPv2v.js","assets/MyBookingsPage-CRcd_7Y1.js","assets/StatusBadge-pAfNALge.js","assets/MyHomeCollectionsPage-Diky4qqb.js","assets/map-pin-d1n1VtEa.js","assets/HomeCollectionPage-CTyhiCCJ.js","assets/textarea-k7rfGQfk.js","assets/navigation-Cq1Nfg_3.js","assets/ReportsPage-CENIk8GF.js","assets/eye-dwgbLP3l.js","assets/download-BqkVBFJs.js","assets/MyVitalsPage-DjZ-sTCD.js","assets/heart-9mFiG_Qo.js","assets/ProfilePage-8Gj1Pv3_.js","assets/alert-dialog-URaVzQX0.js","assets/badge-D3JjccXe.js","assets/user-3cqi50I0.js","assets/building-2-B5khrFwf.js","assets/chevron-right-CvoaUNnL.js","assets/MyHospitalSamplesPage-C3-aOJRq.js","assets/deliveryHelpers-C5I7rS3C.js","assets/truck-EvWw2Thu.js","assets/demoData-BTN7Zcds.js"])))=>i.map(i=>d[i]);
import { a as useInternetIdentity, b as useQueryClient, j as jsxRuntimeExports, r as reactExports, L as LoadingScreen, E as ErrorBoundary, _ as __vitePreload } from "./index-vGeq55gD.js";
import { G as GradientButton } from "./GradientButton-4fP7LxFy.js";
import { H as HealthcareBg, F as FlaskConical, a as House, b as FileText, c as cn, u as useGetCallerUserProfile, P as ProfileSetupModal } from "./ProfileSetupModal-DOcw6VTl.js";
import { H as Heart } from "./heart-9mFiG_Qo.js";
import { A as Activity } from "./activity-BR6O5kWC.js";
...
const PatientHomePage = reactExports.lazy(() => __vitePreload(() => import("./PatientHomePage-Ci6k_Bp6.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7]) : void 0));
const BookTestPage = reactExports.lazy(() => __vitePreload(() => import("./BookTestPage-XiWn6DqC.js"), true ? __vite__mapDeps([8,1,2,9,3,10,11,12,13,14,15,7]) : void 0));
const SlotSelectionPage = reactExports.lazy(
  () => __vitePreload(() => import("./SlotSelectionPage-BRtVE6uu.js"), true ? __vite__mapDeps([16,1,2,17,18,3,19,20]) : void 0)
);
const MyBookingsPage = reactExports.lazy(() => __vitePreload(() => import("./MyBookingsPage-CRcd_7Y1.js"), true ? __vite__mapDeps([21,1,2,4,3,12,13,22,6,19]) : void 0));
const MyHomeCollectionsPage = reactExports.lazy(
  () => __vitePreload(() => import("./MyHomeCollectionsPage-Diky4qqb.js"), true ? __vite__mapDeps([23,1,2,4,3,22,24,19]) : void 0)
);
const HomeCollectionPage = reactExports.lazy(
  () => __vitePreload(() => import("./HomeCollectionPage-CTyhiCCJ.js"), true ? __vite__mapDeps([25,1,2,9,3,10,11,26,17,12,13,24,27,15,19,7]) : void 0)
);
const ReportsPage = reactExports.lazy(() => __vitePreload(() => import("./ReportsPage-CENIk8GF.js"), true ? __vite__mapDeps([28,1,2,4,3,12,13,29,30]) : void 0));
const MyVitalsPage = reactExports.lazy(() => __vitePreload(() => import("./MyVitalsPage-DjZ-sTCD.js"), true ? __vite__mapDeps([31,1,2,4,3,5,32]) : void 0));
const ProfilePage = reactExports.lazy(() => __vitePreload(() => import("./ProfilePage-8Gj1Pv3_.js"), true ? __vite__mapDeps([33,1,2,34,3,9,10,35,11,17,36,37,38]) : void 0));
const PatientMyHospitalSamplesPage = reactExports.lazy(
  () => __vitePreload(() => import("./MyHospitalSamplesPage-C3-aOJRq.js"), true ? __vite__mapDeps([39,1,2,35,3,10,40,20,41,37,42]) : void 0)
);
const NAV_ITEMS = [
