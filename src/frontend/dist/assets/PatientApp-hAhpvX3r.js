const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/PatientHomePage-oTrRC-zd.js","assets/index-EpO8wkOw.js","assets/index-cM6RQxPB.css","assets/ProfileSetupModal-BqZef24Y.js","assets/MedicalCard-4r9VTJDw.js","assets/activity-DB37RRKF.js","assets/calendar-AF5SiRMx.js","assets/arrow-right-4ESd472v.js","assets/BookTestPage-CVOIuzR0.js","assets/button-DJOwY0WZ.js","assets/index-DujKwYOa.js","assets/input-B2yQ_-Jq.js","assets/PageHeroHeader-nOw1LtoY.js","assets/plus-DpgpGWQz.js","assets/search-g_2bLK7M.js","assets/minus-HwnsR0mw.js","assets/SlotSelectionPage-CQtqZiIJ.js","assets/index-ufi_fU9D.js","assets/GradientButton-CWqnCphk.js","assets/clock-HoNNBDMD.js","assets/circle-check-CrKGi5gi.js","assets/MyBookingsPage-My5Bw1QE.js","assets/StatusBadge-PLTqEDd8.js","assets/MyHomeCollectionsPage-Bz7DH0op.js","assets/map-pin-Cq8Nz6Vp.js","assets/HomeCollectionPage-D3zIpQTd.js","assets/navigation-B3u8CUDD.js","assets/ReportsPage-DMtCn4Jv.js","assets/eye-CTaps2Wz.js","assets/download-CQHVpBuG.js","assets/MyVitalsPage-BSg5-V_H.js","assets/heart-DjUn0k1T.js","assets/ProfilePage-M6qqwHM1.js","assets/alert-dialog-BafpQ3wZ.js","assets/badge-DF311_Sk.js","assets/user-2EH-jK4Q.js","assets/building-2-CVSU91ve.js","assets/chevron-right-MNVEKWil.js","assets/log-out-BQ41imCT.js","assets/MyHospitalSamplesPage-DqZBQ_yX.js","assets/deliveryHelpers-DSLvf7Hf.js","assets/truck-cRIgxYaK.js","assets/microscope-CmU4q5tU.js","assets/package-Btj2B5vr.js","assets/chevron-up-Dl1uYteo.js"])))=>i.map(i=>d[i]);
import { a as useInternetIdentity, b as useQueryClient, j as jsxRuntimeExports, r as reactExports, L as LoadingScreen, E as ErrorBoundary, _ as __vitePreload } from "./index-EpO8wkOw.js";
import { G as GradientButton } from "./GradientButton-CWqnCphk.js";
import { H as HealthcareBg, F as FlaskConical, a as House, b as FileText, c as cn, u as useGetCallerUserProfile, P as ProfileSetupModal } from "./ProfileSetupModal-BqZef24Y.js";
import { H as Heart } from "./heart-DjUn0k1T.js";
import { A as Activity } from "./activity-DB37RRKF.js";
...
const PatientHomePage = reactExports.lazy(() => __vitePreload(() => import("./PatientHomePage-oTrRC-zd.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7]) : void 0));
const BookTestPage = reactExports.lazy(() => __vitePreload(() => import("./BookTestPage-CVOIuzR0.js"), true ? __vite__mapDeps([8,1,2,9,3,10,11,12,13,14,15,7]) : void 0));
const SlotSelectionPage = reactExports.lazy(
  () => __vitePreload(() => import("./SlotSelectionPage-CQtqZiIJ.js"), true ? __vite__mapDeps([16,1,2,17,18,3,19,20]) : void 0)
);
const MyBookingsPage = reactExports.lazy(() => __vitePreload(() => import("./MyBookingsPage-My5Bw1QE.js"), true ? __vite__mapDeps([21,1,2,4,3,12,13,22,6,19]) : void 0));
const MyHomeCollectionsPage = reactExports.lazy(
  () => __vitePreload(() => import("./MyHomeCollectionsPage-Bz7DH0op.js"), true ? __vite__mapDeps([23,1,2,4,3,22,24,19]) : void 0)
);
const HomeCollectionPage = reactExports.lazy(
  () => __vitePreload(() => import("./HomeCollectionPage-D3zIpQTd.js"), true ? __vite__mapDeps([25,1,2,9,3,10,11,17,12,13,24,26,15,19,7]) : void 0)
);
const ReportsPage = reactExports.lazy(() => __vitePreload(() => import("./ReportsPage-DMtCn4Jv.js"), true ? __vite__mapDeps([27,1,2,4,3,12,13,28,29]) : void 0));
const MyVitalsPage = reactExports.lazy(() => __vitePreload(() => import("./MyVitalsPage-BSg5-V_H.js"), true ? __vite__mapDeps([30,1,2,4,3,5,31]) : void 0));
const ProfilePage = reactExports.lazy(() => __vitePreload(() => import("./ProfilePage-M6qqwHM1.js"), true ? __vite__mapDeps([32,1,2,33,3,9,10,34,11,17,35,36,37,38]) : void 0));
const PatientMyHospitalSamplesPage = reactExports.lazy(
  () => __vitePreload(() => import("./MyHospitalSamplesPage-DqZBQ_yX.js"), true ? __vite__mapDeps([39,1,2,34,3,10,40,20,41,36,42,43,44]) : void 0)
);
const NAV_ITEMS = [
