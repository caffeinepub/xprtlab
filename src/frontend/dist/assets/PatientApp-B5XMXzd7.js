const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/PatientHomePage-Nf1rFwIs.js","assets/index-77iKE7z5.js","assets/index-Bi0ymLj4.css","assets/ProfileSetupModal-BB_monh5.js","assets/MedicalCard-DDeCY5r4.js","assets/activity-C1inOyT9.js","assets/calendar-CFbJdD6f.js","assets/arrow-right-46BWdYVv.js","assets/BookTestPage-B1ko91tP.js","assets/button-DrsLRlpx.js","assets/index-fFFU_iCT.js","assets/input-BUljrT4O.js","assets/PageHeroHeader-DMNNWZUS.js","assets/plus-B03gg-WC.js","assets/search-Bq-Fk22W.js","assets/minus-CCuxixdo.js","assets/SlotSelectionPage-BC9nVJV1.js","assets/index-DnGMpjq-.js","assets/GradientButton-CD5g_dqu.js","assets/clock-BEcvoIYA.js","assets/circle-check-BE62QPGq.js","assets/MyBookingsPage-C082qY5h.js","assets/StatusBadge-BYhnnOmo.js","assets/MyHomeCollectionsPage-CNUWr588.js","assets/map-pin-BZNwjx3t.js","assets/HomeCollectionPage-Cs1yrbRL.js","assets/navigation-DSXQqF3D.js","assets/ReportsPage-CoIzKtZ4.js","assets/eye-CweXo0nh.js","assets/download-BJ2bWgmm.js","assets/MyVitalsPage-Cpzc6fCz.js","assets/heart-B07-T4iw.js","assets/ProfilePage-QNR0niYO.js","assets/alert-dialog-D0ku9KB2.js","assets/badge-Ria_zxvE.js","assets/user-EeFrjssy.js","assets/building-2-63YCEJlt.js","assets/chevron-right-CLMqCVcQ.js","assets/MyHospitalSamplesPage-Ci54qVgc.js","assets/deliveryHelpers-BurkprDa.js","assets/truck-Bmubkk6r.js","assets/microscope-BLReGr-F.js","assets/demoData-wn8GRowF.js","assets/chevron-up--esJi3jb.js"])))=>i.map(i=>d[i]);
import { a as useInternetIdentity, b as useQueryClient, j as jsxRuntimeExports, r as reactExports, L as LoadingScreen, E as ErrorBoundary, _ as __vitePreload } from "./index-77iKE7z5.js";
import { G as GradientButton } from "./GradientButton-CD5g_dqu.js";
import { H as HealthcareBg, F as FlaskConical, a as House, b as FileText, c as cn, u as useGetCallerUserProfile, P as ProfileSetupModal } from "./ProfileSetupModal-BB_monh5.js";
import { H as Heart } from "./heart-B07-T4iw.js";
...
const PatientHomePage = reactExports.lazy(() => __vitePreload(() => import("./PatientHomePage-Nf1rFwIs.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7]) : void 0));
const BookTestPage = reactExports.lazy(() => __vitePreload(() => import("./BookTestPage-B1ko91tP.js"), true ? __vite__mapDeps([8,1,2,9,3,10,11,12,13,14,15,7]) : void 0));
const SlotSelectionPage = reactExports.lazy(
  () => __vitePreload(() => import("./SlotSelectionPage-BC9nVJV1.js"), true ? __vite__mapDeps([16,1,2,17,18,3,19,20]) : void 0)
);
const MyBookingsPage = reactExports.lazy(() => __vitePreload(() => import("./MyBookingsPage-C082qY5h.js"), true ? __vite__mapDeps([21,1,2,4,3,12,13,22,6,19]) : void 0));
const MyHomeCollectionsPage = reactExports.lazy(
  () => __vitePreload(() => import("./MyHomeCollectionsPage-CNUWr588.js"), true ? __vite__mapDeps([23,1,2,4,3,22,24,19]) : void 0)
);
const HomeCollectionPage = reactExports.lazy(
  () => __vitePreload(() => import("./HomeCollectionPage-Cs1yrbRL.js"), true ? __vite__mapDeps([25,1,2,9,3,10,11,17,12,13,24,26,15,19,7]) : void 0)
);
const ReportsPage = reactExports.lazy(() => __vitePreload(() => import("./ReportsPage-CoIzKtZ4.js"), true ? __vite__mapDeps([27,1,2,4,3,12,13,28,29]) : void 0));
const MyVitalsPage = reactExports.lazy(() => __vitePreload(() => import("./MyVitalsPage-Cpzc6fCz.js"), true ? __vite__mapDeps([30,1,2,4,3,5,31]) : void 0));
const ProfilePage = reactExports.lazy(() => __vitePreload(() => import("./ProfilePage-QNR0niYO.js"), true ? __vite__mapDeps([32,1,2,33,3,9,10,34,11,17,35,36,37]) : void 0));
const PatientMyHospitalSamplesPage = reactExports.lazy(
  () => __vitePreload(() => import("./MyHospitalSamplesPage-Ci54qVgc.js"), true ? __vite__mapDeps([38,1,2,34,3,10,39,20,40,36,41,42,43]) : void 0)
);
const NAV_ITEMS = [
