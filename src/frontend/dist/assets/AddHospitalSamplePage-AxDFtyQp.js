...
import { b as TestTube, c as getHospitals, d as getTests, e as createSample } from "./StaffApp-Ba4Evg6w.js";
...
import { U as User, f as Phone } from "./sessionUtils-D-kS_i2l.js";
import { M as Minus } from "./minus-Da9MJ8eb.js";
...
function AddHospitalSamplePage({
  ...
  const [_allHospitals, setAllHospitals] = reactExports.useState([]);
  ...
  reactExports.useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const filteredHospitals2 = (hospitalsData || []).filter(
          (h) => {
        ...
        console.log("Filtered hospitals:", filteredHospitals2);
        setHospitals(filteredHospitals2);
        if (filteredHospitals2.length === 1) {
          setSelectedHospitalId(filteredHospitals2[0].id);
        }
        setAvailableTests(
          (testsData || []).map((t) => ({
            testId: t.id,
