import { a as useQueryClient, r as reactExports, j as jsxRuntimeExports } from "./index-CAVbGvzl.js";
...
import { j as getSession, P as Principal, U as User, S as Shield, f as Phone } from "./sessionUtils-D-kS_i2l.js";
import { u as ue } from "./index-nAdPOPfy.js";
import { u as useGetCallerUserProfile, g as useGetAssignedHospitals, h as useGetHospitalsByPhlebotomist, i as useHospitals, j as useRemovePhlebotomistFromHospital } from "./useQueries-vGFyea1k.js";
...
import { L as LogOut } from "./log-out-CzT9_g4Y.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-4 max-w-lg mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl border border-border shadow-sm p-5 flex items-center gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-w-0", children: profileLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-base text-foreground truncate", children: (userProfile == null ? void 0 : userProfile.name) || (session == null ? void 0 : session.mobile) || "User" }),
        ...
        ((userProfile == null ? void 0 : userProfile.phone) || (session == null ? void 0 : session.mobile)) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: (userProfile == null ? void 0 : userProfile.phone) ?? (session == null ? void 0 : session.mobile) }),
    ...
    (session == null ? void 0 : session.mobile) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl border border-border shadow-sm p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-4 w-4 text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-foreground", children: "Logged In As" })
      ] }),
