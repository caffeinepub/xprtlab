...
import { S as Subscribable, p as pendingThenable, b as resolveEnabled, s as shallowEqualObjects, c as resolveStaleTime, n as noop, e as environmentManager, i as isValidTimeout, t as timeUntilStale, d as timeoutManager, f as focusManager, g as fetchState, h as replaceData, k as notifyManager, l as hashKey, m as getDefaultState, r as reactExports, o as shouldThrowError, a as useQueryClient } from "./index-CAVbGvzl.js";
...
function useAddTest() {
  ...
  return useMutation({
    mutationFn: async (input) => {
      ...
      console.log("Actor available:", false);
      throw new Error("Actor not available");
    },
    onSuccess: () => {
...
export {
  useConfirmWhatsAppDelivery as A,
  useGetAllActiveShifts as B,
  useGetAttendanceByPhlebotomist as C,
  useGetSecurityLogs as D,
  useResetDeviceBinding as E,
  useAddTest as F,
  useDisableTest as G,
  useUpdateTest as H,
  useBulkAddTests as I,
  useSetTestStatus as J,
  useAddHospital as K,
  useUpdateHospital as L,
  useDisableHospital as M,
  useHospitalById as N,
  useGetPhlebotomistsByHospital as O,
  useAssignPhlebotomistToHospital as P,
  useGetSettlementHistory as Q,
  useMarkSettlement as R,
  useGetAllTests as a,
  useCreateBooking as b,
  useGetMyBookings as c,
  useGetMyHomeCollectionRequests as d,
  useCreateHomeCollectionRequest as e,
  useGetMyReports as f,
  useGetAssignedHospitals as g,
  useGetHospitalsByPhlebotomist as h,
  useHospitals as i,
  useRemovePhlebotomistFromHospital as j,
  useGetHospitalSamplesByPhone as k,
  useRecordBPReading as l,
  useRecordRBSReading as m,
  useGetTodaySummary as n,
  useGetAllBookings as o,
  useUpdateBookingStatus as p,
  useUploadReport as q,
  useGetAllReports as r,
  useGetAllIncidents as s,
  useQuery as t,
  useGetCallerUserProfile as u,
  useSubmitIncident as v,
  useGetAllHospitalSamples as w,
  useUpdateHospitalSampleBilling as x,
  useMarkAsDispatched as y,
  useMarkSampleDelivered as z
};
