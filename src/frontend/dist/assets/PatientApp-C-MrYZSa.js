const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/PatientHomePage-D0o_tElI.js","assets/index-B29_aZcc.js","assets/index-cM6RQxPB.css","assets/ProfileSetupModal-DwXJWROi.js","assets/MedicalCard-v5Kfl5O0.js","assets/activity-DL-9iXwz.js","assets/calendar-DV7r5Lhs.js","assets/arrow-right-C4yul0pZ.js","assets/BookTestPage-cVBFkPHL.js","assets/button-ClSivQPz.js","assets/index-DnfcsZcs.js","assets/input-3l5J3LRN.js","assets/PageHeroHeader-BLfguPAr.js","assets/plus-DOSYt_dr.js","assets/search-CIA8ROPJ.js","assets/minus-C0Rwsjpz.js","assets/SlotSelectionPage-CLyDC00H.js","assets/index-BGKhRoWp.js","assets/GradientButton-C4SZrtsM.js","assets/clock-CupVO3re.js","assets/circle-check-V8WsfPFK.js","assets/MyBookingsPage-f92noUFk.js","assets/StatusBadge-BAsCvvH0.js","assets/MyHomeCollectionsPage-PypIHtZe.js","assets/map-pin-CoZ71N1A.js","assets/HomeCollectionPage-QxQl3rkm.js","assets/navigation-BPI5PfgO.js","assets/ReportsPage-cLyxt9ts.js","assets/eye-Die3BcC2.js","assets/download-t0HEwMEo.js","assets/MyVitalsPage-IS2WizhI.js","assets/heart-Di5DZ6e1.js","assets/ProfilePage-CplvOi8m.js","assets/alert-dialog-D4MG_iP4.js","assets/badge-Bkt7ilfM.js","assets/user-DhOxXjfF.js","assets/building-2-DKM2UYoH.js","assets/chevron-right-4aymMhpj.js","assets/log-out-CJIH_rzv.js","assets/MyHospitalSamplesPage-ZNYe_jZi.js","assets/deliveryHelpers-BDeNkC4c.js","assets/truck-CHT6ZceP.js","assets/microscope-f19Ie4ni.js","assets/package-mOy0U58y.js","assets/chevron-up-MKLUdFEB.js"])))=>i.map(i=>d[i]);
import { a as useInternetIdentity, b as useQueryClient, j as jsxRuntimeExports, r as reactExports, L as LoadingScreen, E as ErrorBoundary, _ as __vitePreload } from "./index-B29_aZcc.js";
import { G as GradientButton } from "./GradientButton-C4SZrtsM.js";
import { H as HealthcareBg, F as FlaskConical, a as House, b as FileText, c as cn, u as useGetCallerUserProfile, P as ProfileSetupModal } from "./ProfileSetupModal-DwXJWROi.js";
import { H as Heart } from "./heart-Di5DZ6e1.js";
import { A as Activity } from "./activity-DL-9iXwz.js";
...
const PatientHomePage = reactExports.lazy(() => __vitePreload(() => import("./PatientHomePage-D0o_tElI.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7]) : void 0));
const BookTestPage = reactExports.lazy(() => __vitePreload(() => import("./BookTestPage-cVBFkPHL.js"), true ? __vite__mapDeps([8,1,2,9,3,10,11,12,13,14,15,7]) : void 0));
const SlotSelectionPage = reactExports.lazy(
  () => __vitePreload(() => import("./SlotSelectionPage-CLyDC00H.js"), true ? __vite__mapDeps([16,1,2,17,18,3,19,20]) : void 0)
);
const MyBookingsPage = reactExports.lazy(() => __vitePreload(() => import("./MyBookingsPage-f92noUFk.js"), true ? __vite__mapDeps([21,1,2,4,3,12,13,22,6,19]) : void 0));
const MyHomeCollectionsPage = reactExports.lazy(
  () => __vitePreload(() => import("./MyHomeCollectionsPage-PypIHtZe.js"), true ? __vite__mapDeps([23,1,2,4,3,22,24,19]) : void 0)
);
const HomeCollectionPage = reactExports.lazy(
  () => __vitePreload(() => import("./HomeCollectionPage-QxQl3rkm.js"), true ? __vite__mapDeps([25,1,2,9,3,10,11,17,12,13,24,26,15,19,7]) : void 0)
);
const ReportsPage = reactExports.lazy(() => __vitePreload(() => import("./ReportsPage-cLyxt9ts.js"), true ? __vite__mapDeps([27,1,2,4,3,12,13,28,29]) : void 0));
const MyVitalsPage = reactExports.lazy(() => __vitePreload(() => import("./MyVitalsPage-IS2WizhI.js"), true ? __vite__mapDeps([30,1,2,4,3,5,31]) : void 0));
const ProfilePage = reactExports.lazy(() => __vitePreload(() => import("./ProfilePage-CplvOi8m.js"), true ? __vite__mapDeps([32,1,2,33,3,9,10,34,11,17,35,36,37,38]) : void 0));
const PatientMyHospitalSamplesPage = reactExports.lazy(
  () => __vitePreload(() => import("./MyHospitalSamplesPage-ZNYe_jZi.js"), true ? __vite__mapDeps([39,1,2,34,3,10,40,20,41,36,42,43,44]) : void 0)
);
const NAV_ITEMS = [
