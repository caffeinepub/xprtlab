...
import { a as getHospitals, b as getTests, c as createSample } from "./backendService-CU726I6a.js";
import { C as CircleCheckBig } from "./circle-check-big-B-qez6Yx.js";
import { L as LoaderCircle } from "./ProfileSetupModal-DsNpyszE.js";
import { B as Building2 } from "./building-2-BkYRfHAR.js";
import { S as Search } from "./search-B517PK3W.js";
import { U as User, P as Phone } from "./user-aOUTgKBy.js";
import { b as TestTube } from "./StaffApp-BBfDbPBN.js";
import { M as Minus } from "./minus-DZhVQWEM.js";
...
function AddHospitalSamplePage({
  ...
  const [availableTests, setAvailableTests] = reactExports.useState([]);
  ...
  const [backendSampleId, setBackendSampleId] = reactExports.useState(null);
  const [error, setError] = reactExports.useState("");
  reactExports.useEffect(() => {
    Promise.all([getHospitals(), getTests()]).then(([hospList, testList]) => {
      ...
      setAvailableTests(
        testList.filter((t) => t.isActive).map((t) => ({
          testId: t.id,
          testName: t.name,
          testCode: t.code,
          price: Number(t.mrp),
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const createdByMobile = (session == null ? void 0 : session.mobileNumber) ?? (session == null ? void 0 : session.mobile) ?? "";
      const sampleInput = {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              backendSampleId && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  style: {
                    color: "#2563EB",
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-10 h-10 text-blue-500 mx-auto animate-spin mb-3" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#6B7280", fontSize: 14 }, children: "Loading hospitals and tests..." })
        ] })
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen pb-[90px]", style: { background: "#F7F9FC" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: cardStyle, children: [
        ...
        hospitals.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            style: {
              fontSize: "14px",
            ...
            children: "No hospitals found. Ask Super Admin to add hospitals."
          }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: cardStyle, children: [
        ...
        availableTests.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            style: {
              fontSize: "14px",
            ...
            "data-ocid": "add_sample.empty_state",
            children: "No tests available. Ask Super Admin to add test."
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: filteredTests.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  style: {
                    fontSize: "13px",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            test.testCode && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "div",
                              {
                              ...
                              "div",
                              {
                                ...
                                children: [
                                  ...
                                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#6b7280" }, children: [
                                    "Lab: ₹",
                                    Number(test.lab_cost || 0)
                                  ] }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                    "span",
                                    {
                                      style: {
                                        color: test.profit && Number(test.profit) > 0 ? "#16a34a" : "#dc2626",
                                        fontWeight: 500
                                      },
                                      children: [
                                        "Profit: ₹",
                                        Number(test.profit || 0)
                                      ]
                                    }
                                  )
                                ]
