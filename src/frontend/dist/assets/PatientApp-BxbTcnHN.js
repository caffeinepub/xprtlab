const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/PatientHomePage-LLf_CyJK.js","assets/index-WR58nuq7.js","assets/index-D8pLoTIi.css","assets/ProfileSetupModal-COkNxNJQ.js","assets/MedicalCard-S6ovU3QN.js","assets/activity-DbPoPRSl.js","assets/calendar-yCN4Pyzg.js","assets/arrow-right-CsomU-Dj.js","assets/BookTestPage-TrFcr7V5.js","assets/button-C4Auq11P.js","assets/index-CxfO1KSR.js","assets/input-BKeSr0IN.js","assets/PageHeroHeader-DCturIRM.js","assets/plus-BxRvoqyl.js","assets/search-BHltAGtY.js","assets/minus-BNCu_zsF.js","assets/SlotSelectionPage-DrBpXhvS.js","assets/index-B7ov5umw.js","assets/GradientButton-CqGK94sJ.js","assets/clock-BrRDaHVx.js","assets/circle-check-BrgMNbL5.js","assets/MyBookingsPage-fCBqJlrb.js","assets/StatusBadge-KxEMHUSQ.js","assets/MyHomeCollectionsPage-Ch9b1HyB.js","assets/map-pin-D-95OTFC.js","assets/HomeCollectionPage-B-fDcxU_.js","assets/navigation-DFmRCYRM.js","assets/ReportsPage-Bu1-TF-D.js","assets/eye-2AN1v3Kr.js","assets/download-DuXMbScN.js","assets/MyVitalsPage-BMtmDwE8.js","assets/heart-CMxiIJIi.js","assets/ProfilePage-C0qd8rYs.js","assets/alert-dialog-D40H6Qy7.js","assets/badge-82G0moSv.js","assets/user-CsdUA_VC.js","assets/building-2-VWtpBH9c.js","assets/chevron-right-CbsHjuSc.js","assets/log-out-DAk5h1En.js","assets/MyHospitalSamplesPage-D1MShak4.js","assets/deliveryHelpers-BPWuA2Wd.js","assets/truck-BMbp4_rT.js","assets/microscope-BXauceuB.js","assets/package-BuILCwKm.js","assets/chevron-up-BD_q5V18.js"])))=>i.map(i=>d[i]);
import { a as useInternetIdentity, b as useQueryClient, j as jsxRuntimeExports, r as reactExports, L as LoadingScreen, E as ErrorBoundary, _ as __vitePreload } from "./index-WR58nuq7.js";
import { G as GradientButton } from "./GradientButton-CqGK94sJ.js";
import { H as HealthcareBg, F as FlaskConical, a as House, b as FileText, c as cn, u as useGetCallerUserProfile, P as ProfileSetupModal } from "./ProfileSetupModal-COkNxNJQ.js";
import { H as Heart } from "./heart-CMxiIJIi.js";
import { A as Activity } from "./activity-DbPoPRSl.js";
...
const PatientHomePage = reactExports.lazy(() => __vitePreload(() => import("./PatientHomePage-LLf_CyJK.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7]) : void 0));
const BookTestPage = reactExports.lazy(() => __vitePreload(() => import("./BookTestPage-TrFcr7V5.js"), true ? __vite__mapDeps([8,1,2,9,3,10,11,12,13,14,15,7]) : void 0));
const SlotSelectionPage = reactExports.lazy(
  () => __vitePreload(() => import("./SlotSelectionPage-DrBpXhvS.js"), true ? __vite__mapDeps([16,1,2,17,18,3,19,20]) : void 0)
);
const MyBookingsPage = reactExports.lazy(() => __vitePreload(() => import("./MyBookingsPage-fCBqJlrb.js"), true ? __vite__mapDeps([21,1,2,4,3,12,13,22,6,19]) : void 0));
const MyHomeCollectionsPage = reactExports.lazy(
  () => __vitePreload(() => import("./MyHomeCollectionsPage-Ch9b1HyB.js"), true ? __vite__mapDeps([23,1,2,4,3,22,24,19]) : void 0)
);
const HomeCollectionPage = reactExports.lazy(
  () => __vitePreload(() => import("./HomeCollectionPage-B-fDcxU_.js"), true ? __vite__mapDeps([25,1,2,9,3,10,11,17,12,13,24,26,15,19,7]) : void 0)
);
const ReportsPage = reactExports.lazy(() => __vitePreload(() => import("./ReportsPage-Bu1-TF-D.js"), true ? __vite__mapDeps([27,1,2,4,3,12,13,28,29]) : void 0));
const MyVitalsPage = reactExports.lazy(() => __vitePreload(() => import("./MyVitalsPage-BMtmDwE8.js"), true ? __vite__mapDeps([30,1,2,4,3,5,31]) : void 0));
const ProfilePage = reactExports.lazy(() => __vitePreload(() => import("./ProfilePage-C0qd8rYs.js"), true ? __vite__mapDeps([32,1,2,33,3,9,10,34,11,17,35,36,37,38]) : void 0));
const PatientMyHospitalSamplesPage = reactExports.lazy(
  () => __vitePreload(() => import("./MyHospitalSamplesPage-D1MShak4.js"), true ? __vite__mapDeps([39,1,2,34,3,10,40,20,41,36,42,43,44]) : void 0)
);
const NAV_ITEMS = [
