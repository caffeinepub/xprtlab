...
import { S as Subscribable, p as pendingThenable, d as resolveEnabled, s as shallowEqualObjects, e as resolveStaleTime, n as noop, i as isServer, f as isValidTimeout, t as timeUntilStale, g as timeoutManager, h as focusManager, k as fetchState, l as replaceData, m as notifyManager, o as hashKey, q as getDefaultState, r as reactExports, v as shouldThrowError, b as useQueryClient, j as jsxRuntimeExports, w as React, x as reactDomExports, y as ReactDOM, c as createActorWithConfig, a as useInternetIdentity, A as AppRole } from "./index-DUzgVkrU.js";
...
let _icIdentityActor = null;
let _icIdentityRef = null;
...
async function getActor() {
  ...
  const icIdentity = (_a2 = window.ic) == null ? void 0 : _a2.identity;
  if (icIdentity) {
...
export {
  createContextScope as $,
  createSample as A,
  getSamplesByMobile as B,
  useGetAllBookings as C,
  useUpdateBookingStatus as D,
  useUploadReport as E,
  FlaskConical as F,
  useGetAllReports as G,
  HealthcareBg as H,
  useGetAllIncidents as I,
  useActor as J,
  useQuery as K,
  LoaderCircle as L,
  useSubmitIncident as M,
  useGetAllHospitalSamples as N,
  useUpdateHospitalSampleBilling as O,
  ProfileSetupModal as P,
  useMarkAsDispatched as Q,
  useMarkSampleDelivered as R,
  useConfirmWhatsAppDelivery as S,
  Dialog as T,
  DialogContent as U,
  DialogHeader as V,
  DialogTitle as W,
  ...
  composeEventHandlers as a2,
  Presence as a3,
  useGetAllActiveShifts as a4,
  useGetAttendanceByPhlebotomist as a5,
  useGetSecurityLogs as a6,
  useResetDeviceBinding as a7,
  useAddTest as a8,
  useDisableTest as a9,
  getDashboardMetrics as aA,
  useGetSettlementHistory as aB,
  useMarkSettlement as aC,
  getAllAppUsers as aD,
  registerAppUser as aE,
  getAllTasks as aF,
  createTask as aG,
  useUpdateTest as aa,
  useBulkAddTests as ab,
  useSetTestStatus as ac,
  useLayoutEffect2 as ad,
  Slot$1 as ae,
  clsx as af,
  createDialogScope as ag,
  Root as ah,
  WarningProvider as ai,
  Content as aj,
  createSlottable as ak,
  Title as al,
  Description as am,
  Close as an,
  Portal as ao,
  ...
  useAddHospital as au,
  useUpdateHospital as av,
  useDisableHospital as aw,
  useHospitalById as ax,
  useGetPhlebotomistsByHospital as ay,
  useAssignPhlebotomistToHospital as az,
  FileText as b,
  cn as c,
  createLucideIcon as d,
  claimSuperAdmin as e,
  useGetAllTests as f,
  getUserByMobile as g,
  useCreateBooking as h,
  useGetMyBookings as i,
  useGetMyHomeCollectionRequests as j,
  useCreateHomeCollectionRequest as k,
  useGetMyReports as l,
  useGetAssignedHospitals as m,
  useGetHospitalsByPhlebotomist as n,
  useHospitals as o,
  useRemovePhlebotomistFromHospital as p,
  useGetHospitalSamplesByPhone as q,
  resetActorCache as r,
  setAuthenticatedActor as s,
  getTasksByUser as t,
  useGetCallerUserProfile as u,
  useRecordBPReading as v,
  useRecordRBSReading as w,
  useGetTodaySummary as x,
  getHospitals as y,
  getTests as z
};
