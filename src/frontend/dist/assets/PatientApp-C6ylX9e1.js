const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/PatientHomePage-DLjXQHxn.js","assets/index-DUzgVkrU.js","assets/index-cM6RQxPB.css","assets/ProfileSetupModal-CEWh9TB9.js","assets/MedicalCard-BQTcMKEu.js","assets/activity-Ck9XPjjM.js","assets/calendar-DEqH90Im.js","assets/arrow-right-B07sOkXS.js","assets/BookTestPage-CneOEpdX.js","assets/button-CwrFbC47.js","assets/index-jquq-I-I.js","assets/input-Cq3q-Aiu.js","assets/PageHeroHeader-7pM3XNm8.js","assets/plus-DE6UvCfR.js","assets/search-CS4tzI8L.js","assets/minus-CN46ixOM.js","assets/SlotSelectionPage-LO4bHLxu.js","assets/index-BHOzmVMV.js","assets/GradientButton-DJOEGVBV.js","assets/clock-Dbsxssba.js","assets/circle-check-C805daOZ.js","assets/MyBookingsPage-Dx8FE8JS.js","assets/StatusBadge-DvtF_tFl.js","assets/MyHomeCollectionsPage-ChNuoh67.js","assets/map-pin-BxyksOxU.js","assets/HomeCollectionPage-BGXytnhU.js","assets/navigation-DogqmstL.js","assets/ReportsPage-CKI7SuCA.js","assets/eye-BKO6zgW9.js","assets/download-Dy4ZN_B1.js","assets/MyVitalsPage-BldV84Go.js","assets/heart-rCPdnId0.js","assets/ProfilePage-DH9vj4ya.js","assets/alert-dialog-CKAgPgTp.js","assets/badge-CnNDWlgr.js","assets/user-DGbrxc4W.js","assets/building-2-CAq0fpFE.js","assets/chevron-right-Dlo380Mw.js","assets/log-out-DvJlA7mZ.js","assets/MyHospitalSamplesPage-IyOIO_Xa.js","assets/deliveryHelpers-D1bYH3_y.js","assets/truck-seLH3PgA.js","assets/microscope-CZz3Gx7i.js","assets/package-Dp1_2rM6.js","assets/chevron-up-fjUys96t.js"])))=>i.map(i=>d[i]);
import { a as useInternetIdentity, b as useQueryClient, j as jsxRuntimeExports, r as reactExports, L as LoadingScreen, E as ErrorBoundary, _ as __vitePreload } from "./index-DUzgVkrU.js";
import { G as GradientButton } from "./GradientButton-DJOEGVBV.js";
import { H as HealthcareBg, F as FlaskConical, a as House, b as FileText, c as cn, u as useGetCallerUserProfile, P as ProfileSetupModal } from "./ProfileSetupModal-CEWh9TB9.js";
import { H as Heart } from "./heart-rCPdnId0.js";
import { A as Activity } from "./activity-Ck9XPjjM.js";
...
const PatientHomePage = reactExports.lazy(() => __vitePreload(() => import("./PatientHomePage-DLjXQHxn.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7]) : void 0));
const BookTestPage = reactExports.lazy(() => __vitePreload(() => import("./BookTestPage-CneOEpdX.js"), true ? __vite__mapDeps([8,1,2,9,3,10,11,12,13,14,15,7]) : void 0));
const SlotSelectionPage = reactExports.lazy(
  () => __vitePreload(() => import("./SlotSelectionPage-LO4bHLxu.js"), true ? __vite__mapDeps([16,1,2,17,18,3,19,20]) : void 0)
);
const MyBookingsPage = reactExports.lazy(() => __vitePreload(() => import("./MyBookingsPage-Dx8FE8JS.js"), true ? __vite__mapDeps([21,1,2,4,3,12,13,22,6,19]) : void 0));
const MyHomeCollectionsPage = reactExports.lazy(
  () => __vitePreload(() => import("./MyHomeCollectionsPage-ChNuoh67.js"), true ? __vite__mapDeps([23,1,2,4,3,22,24,19]) : void 0)
);
const HomeCollectionPage = reactExports.lazy(
  () => __vitePreload(() => import("./HomeCollectionPage-BGXytnhU.js"), true ? __vite__mapDeps([25,1,2,9,3,10,11,17,12,13,24,26,15,19,7]) : void 0)
);
const ReportsPage = reactExports.lazy(() => __vitePreload(() => import("./ReportsPage-CKI7SuCA.js"), true ? __vite__mapDeps([27,1,2,4,3,12,13,28,29]) : void 0));
const MyVitalsPage = reactExports.lazy(() => __vitePreload(() => import("./MyVitalsPage-BldV84Go.js"), true ? __vite__mapDeps([30,1,2,4,3,5,31]) : void 0));
const ProfilePage = reactExports.lazy(() => __vitePreload(() => import("./ProfilePage-DH9vj4ya.js"), true ? __vite__mapDeps([32,1,2,33,3,9,10,34,11,17,35,36,37,38]) : void 0));
const PatientMyHospitalSamplesPage = reactExports.lazy(
  () => __vitePreload(() => import("./MyHospitalSamplesPage-IyOIO_Xa.js"), true ? __vite__mapDeps([39,1,2,34,3,10,40,20,41,36,42,43,44]) : void 0)
);
const NAV_ITEMS = [
