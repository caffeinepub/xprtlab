...
import { i as useHospitals } from "./useQueries-vGFyea1k.js";
import { c as formatCurrency } from "./formatters-DgcbtmQq.js";
import { g as getProfitStatusColor } from "./profitUtils-CU3rQSve.js";
import { T as TrendingUp, j as ChartColumn } from "./StaffApp-Ba4Evg6w.js";
...
import { R as ResponsiveContainer, L as LineChart, C as CartesianGrid, X as XAxis, Y as YAxis, T as Tooltip, a as Line } from "./LineChart-DCkfofQh.js";
    ...
    "div",
    {
      ...
      children: filters.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `px-4 py-1.5 rounded-full text-xs font-semibold transition-all border ${active === f.key ? "bg-gradient-to-r from-[#2563EB] to-[#26C6DA] text-white border-transparent shadow-sm" : "bg-white text-muted-foreground border-border hover:border-primary/40"}`,
          children: f.label
        },
        f.key
      ))
...
function ProfitDashboardPage({
  ...
  const hospitalProfitData = backendHospitals.map((h) => ({
    id: h.id,
    name: h.name,
    totalTests: 0,
    revenue: 0,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("section", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                hospitalProfitData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
