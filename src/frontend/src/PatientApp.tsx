...
const SlotSelectionPage = lazy(
  () => import("./pages/patient/SlotSelectionPage"),
);
const MyBookingsPage = lazy(() => import("./pages/patient/MyBookingsPage"));
const MyHomeCollectionsPage = lazy(
  () => import("./pages/patient/MyHomeCollectionsPage"),
);
const HomeCollectionPage = lazy(
  () => import("./pages/patient/HomeCollectionPage"),
);
...
const PatientMyHospitalSamplesPage = lazy(
  () => import("./pages/patient/MyHospitalSamplesPage"),
);
