 ...
 * backendTypes.ts
 *
 * Re-exports all backend types used across the application.
 * Components should import from here instead of from "../backend" or "../backend.d"
 * since the generated backend.d.ts is protected and may have an empty backendInterface.
 *
 * These types match the Motoko backend's candid interface exactly.
 */
...
/** Full backend actor interface matching the Motoko canister. */
export interface BackendActor {
  ...
  addTest(
    ...
    { __kind__: "ok"; ok: TestOutput } | { __kind__: "err"; err: TestError }
  >;
  assignCallerUserRole(user: Principal, role: UserRole): Promise<void>;
  assignPhlebotomistToHospital(
    hospitalId: string,
    phlebotomist: Principal,
  ): Promise<HospitalPhlebotomistAssignment>;
  ...
  removePhlebotomistFromHospital(
    hospitalId: string,
    phlebotomist: Principal,
    removalReason: string,
  ): Promise<HospitalPhlebotomistAssignment>;
