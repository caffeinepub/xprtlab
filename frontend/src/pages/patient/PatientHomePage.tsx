...
import { FlaskConical, Home, FileText, Activity, Calendar, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="p-4 space-y-5">
      ...
      <div className="bg-gradient-to-r from-primary to-accent rounded-2xl p-5 text-white shadow-lg">
        ...
        <h2 className="text-2xl font-bold mt-0.5">{profile?.name || 'Patient'} 👋</h2>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-muted-foreground">View all your appointments</p>
            </div>
          </div>
      ...
      <section>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <p className="font-semibold text-sm text-foreground">Home Collections</p>
              <p className="text-xs text-muted-foreground">Track your pickup requests</p>
            </div>
          </div>
          <ArrowRight className="w-4 h-4 text-muted-foreground" />
        </button>
