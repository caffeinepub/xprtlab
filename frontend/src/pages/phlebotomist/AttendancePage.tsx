...
export default function AttendancePage() {
  ...
  // Separate boolean for submission loading to avoid TypeScript narrowing issues
  ...
  const handleStartShift = async () => {
    ...
    // Geofence check (using demo hospital coords; in production use profile hospital coords)
    ...
    return (
      <div className="px-4 py-5 space-y-4 animate-fade-in">
        <div className="text-center py-4">
          ...
          <h1 className="text-xl font-bold text-foreground">Shift Active</h1>
          <p className="text-sm text-muted-foreground">You are checked in</p>
        </div>
  ...
  return (
    <div className="px-4 py-5 space-y-5 animate-fade-in">
      <div className="text-center py-4">
        ...
        <p className="text-sm text-muted-foreground">Start your shift to begin working</p>
      </div>
