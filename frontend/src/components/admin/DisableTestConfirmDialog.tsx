      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            <br />
            The test will be marked as <span className="font-semibold">Inactive</span> and will not be permanently deleted.
            You can re-enable it later by editing the test.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          <AlertDialogCancel disabled={disableTest.isPending}>Cancel</AlertDialogCancel>
          <AlertDialogAction
            onClick={handleConfirm}
            disabled={disableTest.isPending}
            className="bg-destructive text-destructive-foreground hover:bg-destructive/90"
          >
            {disableTest.isPending && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
            Disable Test
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
