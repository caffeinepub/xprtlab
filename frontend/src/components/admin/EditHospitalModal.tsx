...
export default function EditHospitalModal({ open, onOpenChange, hospital }: EditHospitalModalProps) {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Update the hospital details below.</DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <Input id="edit-city" placeholder="e.g. Mumbai" {...register('city')} />
          </div>
          ...
          <div className="space-y-1">
            ...
            <Input id="edit-area" placeholder="e.g. North Zone" {...register('area')} />
          </div>
          ...
          <DialogFooter>
            <Button type="button" variant="outline" onClick={handleClose} disabled={updateHospital.isPending}>
              Cancel
            </Button>
            <Button type="submit" disabled={updateHospital.isPending}>
              {updateHospital.isPending && <Loader2 className="h-4 w-4 mr-2 animate-spin" />}
              Save Changes
            </Button>
          </DialogFooter>
        </form>
