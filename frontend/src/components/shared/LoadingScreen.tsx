...
export default function LoadingScreen({ message = 'Loading...', timeoutMs = 15000 }: LoadingScreenProps) {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <div className="max-w-sm w-full bg-card rounded-2xl shadow-card p-8 text-center">
          ...
          <h2 className="text-lg font-bold text-foreground mb-2">Taking too long</h2>
          <p className="text-muted-foreground text-sm mb-6">
            The app is taking longer than expected to load. Please check your connection and try again.
          </p>
          <button
