...
import { CheckCircle2, Circle, FlaskConical, Truck, Building2, Microscope, FileText, PackageCheck } from 'lucide-react';
...
const STAGES: Array<{ status: SampleStatus; label: string; icon: React.ReactNode }> = [
  {
...
export default function SampleWorkflowTimeline({ currentStatus }: SampleWorkflowTimelineProps) {
